...
// Point points[] = {Point(1, 0), Point(1, 1), Point(0, 1), Point(0,0), Point(0, 1), Point(1,1), Point(0,1), Point(0,3), Point(0,1), Point(2,1), Point(2,2), Point(3,2), Point(3,3), Point(3,2), Point(1,2), Point(1,3)};
// Point points[] = {Point(3, 0), Point(3, 3), Point(2, 3), Point(2, 1), Point(0, 1), Point(0, 0), Point(1, 0), Point(1, 3)};
// Point points[] = {Point(0, 3), Point(3, 3), Point(3, 0), Point(1, 0), Point(1, 3), Point(2, 3), Point(2, 1)};
// Point points[] = {Point(0, 1), Point(1, 1), Point(1, 0), Point(0, 0)};
// Point points[] = {Point(3, 0), Point(3, 2), Point(1, 2), Point(1, 3), Point(2, 3), Point(1, 3), Point(1, 1), Point(0, 1), Point(0, 2)};
Point points[] = {Point(3, 0), Point(3, 2), Point(1, 2), Point(1, 1), Point(1, 3), Point(2, 3), Point(0, 3), Point(0, 2)};
// Point points[] = {Point(2, 3)};



const int points_len = sizeof(points)/sizeof(points[0]);
Point starting_point = Point(2, 0);
bool button_pressed = false;

int straight_speed = 67;
...
{ 
  ...
  kInstructionsBuffer = getPath(points, points_len, starting_point, 0, 83, straight_speed);
