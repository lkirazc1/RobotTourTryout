...
void setup_encoders()
{
    ...
    attachInterrupt(digitalPinToInterrupt(MotorDetectors[0]), ISR_countLeft, RISING);
    attachInterrupt(digitalPinToInterrupt(MotorDetectors[1]), ISR_countR, RISING);
    attachInterrupt(digitalPinToInterrupt(MotorDetectors[2]), ISR_countR, RISING);
    attachInterrupt(digitalPinToInterrupt(MotorDetectors[3]), ISR_countR, RISING);
}
