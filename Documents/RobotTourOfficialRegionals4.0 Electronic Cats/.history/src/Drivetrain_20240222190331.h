...
public:
    ...
    void Calibrate(int speed_perc, bool backwards = false) {
        ...
        {
            calibration_speed_adj_[0] = straightness;
            calibration_speed_adj_[1] = 1;
            calibration_speed_adj_[2] = straightness;
...
private:
    static const int kCheckTime = 35; 
    static const int kCheckTimeP = 1;
    const double kp_left = 5;
    const double ki_left = 0.1;
    const double kp_right = 5;
    const double ki_right = 0.1;
    const double left_buffer = 1.5;
    const double right_buffer = 1.5;
