...
Point points[] = {Point(1, 0), Point(1, 1), Point(0, 1), Point(0,0), Point(0, 1), Point(1,1), Point(0,1), Point(0,3), Point(0,1), Point(2,1), Point(2,2), Point(3,2), Point(3,3), Point(3,2), Point(1,2)};
